...
export default function Hero() {
  return (
    <section className="relative flex h-[calc(100vh-4rem)] w-full overflow-hidden">
      ...
      <div className="xs:pt-8 xs:px-6 xs:gap-4 relative flex w-full flex-col items-start gap-2 px-5 pt-2 sm:gap-6 sm:px-7 sm:pt-10 md:gap-7 md:px-8 md:pt-20 lg:gap-8 lg:px-12 lg:pt-30 xl:gap-10 xl:px-16 xl:pt-49">
